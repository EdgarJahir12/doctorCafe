...
export class DataLayerManager {
  ...
  setDataOptions(layer: AgmDataLayer, options)
  {
    this._layers.get(layer).then(l => {
      l.setControlPosition(options.controlPosition);
      l.setControls(options.controls);
      //let value = (options.drawingMode != null) ? options.drawingMode : null;
      let value = (options.drawingMode != null) ? (options.drawingMode.figure != null ? options.drawingMode.figure : options.drawingMode) : null;
      l.setDrawingMode(value);
